...
use OriceOn\MailTracker\Model\SentEmailUrlClicked;
...
class MailTrackerTest extends SetUpTest
{
    ...
    {
        $url = action('\OriceOn\MailTracker\SNSController@callback');
    ...
    public function it_processes_a_delivery()
    {
        ...
        $response = $this->post(action('\OriceOn\MailTracker\SNSController@callback'), [
                'message' => json_encode([
